...
d1 = hline([2.0,2.0,-1.0],[0.0, 0.0, 1.0])
d2 = hline([-4.0,4.0,6.0],[0.0, 0.0, 1.0])
...
equidist(d1,d2, [10.0,-5.0,0.0],[-5.0,-5.0,0.0])
 (distance2(d1, [10.0,-5.0,0.0])-distance2(d2,[10.0,-5.0,0.0]))*(distance2(d1,[-5.0,-5.0,0.0])-distance2(d2,[-5.0,-5.0,0.0]))
