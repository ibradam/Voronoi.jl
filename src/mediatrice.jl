...
function equidist(H1::HLine, H2::HLine,  H3::HLine, A::Vector{Float64}, B::Vector{Float64})    
    ...
    elseif  H3.m_pt[3]   <  H1.m_pt[3]  &&  H1.m_pt[3] <  H2.m_pt[3]
        ...
        L2 = H1
        L3 = H2
    elseif  H3.m_pt[3]   <  H2.m_pt[3]  &&  H2.m_pt[3] <  H1.m_pt[3]
        L1 = H3
        L2 = H2
        L3 = H1
    end 
    ...
    elseif ya==yb
        ...
        z0=(ya - d1)/c1
        q0=[a1*z0+b1,ya,z0]
        if z0<z1 && min(xa,xb)<=q01[1] && q0[1]<=max(xa,xb) && min(za,zb)<=q0[3] && q0[3]<=max(za,zb)
            return q0
        elseif delta1>=0
            z01=0.5*(-e2 - sqrt(delta))/d2
            q1=[a2*z01*z01+b2*z01+c2,ya,z01]
            z02=0.5*(-e2+sqrt(delta))/d2
    ...
    elseif za==zb
        ...
        q3=[a4,b4,z0]
        if z0<=z1 && min(xa,xb)<=q[1] && q[1]<=max(xa,xb) && min(ya,yb)<=q[2] && q[2]<=max(ya,yb)
            return q0
...
function equidist(H1::HLine, H2::HLine,  H3::HLine, H4::HLine)
    ...
    elseif H4.m_pt[3]< H3.m_pt[3] && H3.m_pt[3]<H1.m_pt[3] && H1.m_pt[3]<H2.m_pt[3]
        ...
        L3 = H1
        L4 = H2
    elseif H4.m_pt[3]< H3.m_pt[3] && H3.m_pt[3]<H2.m_pt[3] && H2.m_pt[3]<H1.m_pt[3]
        L1 = H4
        L2 = H3
        L3 = H2
        L4 = H1
